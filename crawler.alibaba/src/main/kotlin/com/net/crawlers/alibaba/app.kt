...
import com.net.crawlers.alibaba.pageproc.ImageDownloadProcJsonBuilder
import com.net.crawlers.alibaba.pageproc.ProductPageProc
import com.net.crawlers.alibaba.pageproc.ProductPageProcJsonBuilder
...
fun main(args: Array<String>) {
    ...
    sche.registerJsonBuilder(ImageDownloadProcJsonBuilder)
